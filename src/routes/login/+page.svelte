...
<div class="flex min-h-[80vh] items-center justify-center px-4 py-16">
        <div class="w-full max-w-md">
                <div class="mb-8 text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-400">Selamat datang kembali di Playreia</p>
                </div>
                ...
                <div class="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
                        ...
                        <div class="relative my-6">
                                ...
                                <div class="relative flex justify-center text-sm">
                                        <span class="bg-transparent px-2 text-gray-500">atau lanjutkan dengan</span>
                                </div>
                        </div>
